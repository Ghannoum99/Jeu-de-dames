													/************************ PROJET JEU DAMES ************************
                                               ================Jihad GHHANNOUM - Ghassen Bouzeyen - Chahed Benslama================
											         ******************************************************************/
...
void affiche_dame(POINT centre, COULEUR couleur)
{
	POINT p1, p2, p3;
	
	p1.x = centre.x;      p1.y = centre.y + 8;
	p2.x = centre.x - 10; p2.y = centre.y - 10;
	p3.x = centre.x + 10; p3.y = centre.y - 10;
